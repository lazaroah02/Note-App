...
SECRET_KEY = 'django-insecure-2p%(dew4w2%te!_ek$*bpw)bat3gp*%xzh)o6q0f7cg51)$t#b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["127.0.0.1", "lazaronotesapp.pythonanywhere.com"]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['D:\\Projects\\Django Projects\\NoteApp\\NoteApp\\NoteApp\\Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
